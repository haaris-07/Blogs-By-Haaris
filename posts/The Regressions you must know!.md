...
And now that is called an **error**. Based on the error we update the weights. Does a simple subtraction works? let's try:<br>
...
The actual task is in finding the weight updation method.<br>
## Gradient Descent
